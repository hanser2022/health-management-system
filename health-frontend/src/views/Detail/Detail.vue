<template>
  <div class="box_Detail">
    <div class="top_area">
      <p style="cursor: pointer" @click="home">
        <i class="el-icon-s-home" />返回主页
      </p>
    </div>
    <div class="box1">
      <el-image
