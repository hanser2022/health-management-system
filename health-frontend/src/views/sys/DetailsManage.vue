    ...
    >
      <el-form ref="detailFormRef" :model="detailForm">
        <el-form-item label="运动类型" prop="sportType" :label-width="formLabelWidth">
          <el-input v-model="detailForm.sportType" autocomplete="off" />
        </el-form-item>
        ...
        <el-form-item label="运动方法" prop="method" :label-width="formLabelWidth">
          <el-input v-model="detailForm.method" autocomplete="off" />
        </el-form-item>
        ...
        <el-form-item
          ...
          :label-width="formLabelWidth"
        >
          <el-input v-model="detailForm.notes" autocomplete="off" />
        </el-form-item>
